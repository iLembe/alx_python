...
- /number_odd_or_even/<n>: Displays an HTML page with "Number: n is even|odd" inside an H1 tag if n is an integer and checks if it's even or odd.
...
def number_odd_or_even(n):
    """Displays an HTML page with 'Number: n is even|odd' inside an H1 tag if n is an integer."""
    if n % 2 == 0:
